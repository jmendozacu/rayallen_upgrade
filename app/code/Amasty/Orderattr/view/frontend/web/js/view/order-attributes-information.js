        ...
        return Component.extend({
            ...
            getOrderAttributes: function () {
                ...
                for ( var key in attributeValues) {
                    ...
                    var name = 'shippingAddress.custom_attributes.' + key;
                    var fieldDiv = $('div.field[name*="shippingAddress.custom_attributes"][name="'+name+'"]');
                    if (!fieldDiv.length) {
                        continue;
                    }
            ...
            getInputValue: function(fieldDiv, attributeValue, labelFor) {
                ...
                var inputAttribute = fieldDiv.find('[name*="' + _.last(inputName) + '"]:not(.field)');
