...
// forEach that can be used on nodeList
                ...
                if (fieldOptions) {
                    ...
                    for (var _i = 0; _i < fieldOptions.length; _i++) {
                        ...
                        if (optionAttrs.value) {
                            ...
                            var br = '';
                            var classNameLabel = ' class="label-for-version-two"';
                            if (withBr) {
                                br = '<br>';
                                className = '';
                            }
                            optionsMarkup += '<input ' + _optionAttrsString + ' /> <label for="'
                                + optionAttrs.id + '" ' + classNameLabel + '>' + optionAttrs.label + '</label>' + br;
                        }
    ...
    function formBuilderHelpersFn(opts, formBuilder) {
                    ...
                    if (!$field.hasClass('disabled')) {
                        ...
                        (function () {
                            ...
                            multipleField = fieldData.type
                                .match(/(select|dropdown|listbox|radio|radiotwo|checkbox|checkboxtwo|radio-group)/);
        ...
        _helpers.updatePreview = function (field) {
            ...
            if (fieldType.match(/(select|dropdown|listbox|radio|radiotwo|checkbox|checkboxtwo|radio-group)/)) {
                previewData.values = [];
