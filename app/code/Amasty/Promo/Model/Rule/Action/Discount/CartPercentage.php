...
class CartPercentage extends AbstractDiscount
{
    /**
    ...
    public function calculate($rule, $item, $qty)
    {
        ...
        if (!isset($cartRules[$rule->getId()])) {
            if($rule->getSimpleAction() == 'ampromo_percentage'){
                $cartRules[$rule->getId()] = $ruleTotals['base_items_price']*($rule->getDiscountAmount()/100);
            }else {
