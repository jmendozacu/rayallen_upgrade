...
class LoginRequiredOnCustomerSessionInitObserver implements LoginRequiredObserverInterface
{
     ...
     */
    public function __construct(LoginCheckInterface $loginCheckController,\Magento\Store\Model\StoreManagerInterface $storeManager)
    {
    ...
    {
        if($this->storeManager->getStore()->getData('code')=='b2b') {
