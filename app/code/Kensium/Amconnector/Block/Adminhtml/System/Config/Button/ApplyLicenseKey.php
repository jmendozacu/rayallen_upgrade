...
class ApplyLicenseKey extends Field
{
    /**
     * Path to block template
     */
    const BUTTON_TEMPLATE = 'system/config/button/applylicense.phtml';
    ...
    protected function _getElementHtml(AbstractElement $element)
    {
        ...
        $this->addData(
            [
                ...
                'ajax_url' => $this->_urlBuilder->getUrl('amconnector/system_config/applylicense')
            ]
        );
        return $this->_toHtml();
    }
