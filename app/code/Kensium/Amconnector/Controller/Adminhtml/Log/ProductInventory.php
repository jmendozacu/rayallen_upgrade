...
class ProductInventory extends \Kensium\Amconnector\Controller\Adminhtml\Log\AbstractLog
{
    ...
    public function execute()
    {
        ...
        $data['syncStop']= $this->scopeConfigInterface->getValue('amconnectorsync/inventorysync/syncstop');
        $data['path'] = "amconnectorsync/inventorysync/syncstop";
