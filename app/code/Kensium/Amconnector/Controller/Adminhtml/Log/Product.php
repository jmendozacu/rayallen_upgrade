...
class Product extends \Kensium\Amconnector\Controller\Adminhtml\Log\AbstractLog
{
    ...
    public function execute()
    {
        ...
        $data['syncStop']= $this->scopeConfigInterface->getValue('amconnectorsync/productsync/syncstop');
        $data['path'] = "amconnectorsync/productsync/syncstop";
