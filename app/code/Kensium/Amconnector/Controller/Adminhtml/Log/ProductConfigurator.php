...
class ProductConfigurator extends \Kensium\Amconnector\Controller\Adminhtml\Log\AbstractLog
{
    ...
    public function execute()
    {
        ...
        $data['syncStop']= $this->scopeConfigInterface->getValue('amconnectorsync/configuratorsync/syncstop');
        $data['path'] = "amconnectorsync/configuratorsync/syncstop";
