...
/**
 * Class ProductImage
 * @package Kensium\Amconnector\Controller\Adminhtml\Log
 */
class ProductImage extends \Kensium\Amconnector\Controller\Adminhtml\Log\AbstractLog
{
    ...
    public function execute()
    {
        ...
        $data['syncStop']= $this->scopeConfigInterface->getValue('amconnectorsync/productimagesync/syncstop');
        $data['path'] = "amconnectorsync/productimagesync/syncstop";
