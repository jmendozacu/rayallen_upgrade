...
class Category extends \Kensium\Amconnector\Controller\Adminhtml\Log\AbstractLog
{
    /**
     * Index action
     *
    ...
    public function execute()
    {
        ...
        $data['syncStop']= $this->scopeConfigInterface->getValue('amconnectorsync/categorysync/syncstop');
        $data['path'] = "amconnectorsync/categorysync/syncstop";
