...
class OrderShipment extends \Kensium\Amconnector\Controller\Adminhtml\Log\AbstractLog
{
    /**
     * Index action
     *
    ...
    public function execute()
    {
        ...
        $data['syncStop']= $this->scopeConfigInterface->getValue('amconnectorsync/shipmentsync/syncstop');
        $data['path'] = "amconnectorsync/shipmentsync/syncstop";
