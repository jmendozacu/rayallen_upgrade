...
class Edit extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
       ...
       $data = $this->adminSession->getFormData(true);
        ...
        $this
            ->_addContent($page->getLayout()->createBlock('Kensium\Attributemanager\Block\Adminhtml\Customer\Edit'))
            ->_addLeft($page->getLayout()->createBlock('Kensium\Attributemanager\Block\Adminhtml\Customer\Edit\Tabs'))
        ;
