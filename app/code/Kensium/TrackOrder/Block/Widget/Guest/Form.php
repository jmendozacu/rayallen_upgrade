 ...
 */
namespace Kensium\TrackOrder\Block\Widget\Guest;

use Magento\Customer\Model\Context;

class Form extends \Magento\Sales\Block\Widget\Guest\Form implements \Magento\Widget\Block\BlockInterface
{
    /**
    ...
    {
        return $this->getUrl('sales/guest/shipment');
    }
}
