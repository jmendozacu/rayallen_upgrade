...
namespace Kensium\Synclog\Block\Adminhtml\ProductPrice\Renderer;

use Magento\Framework\DataObject;

class ProductPriceLink extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer
{
    /**
