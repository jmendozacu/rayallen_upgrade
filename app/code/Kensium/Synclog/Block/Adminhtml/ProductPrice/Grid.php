...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     * @param \Kensium\Synclog\Model\ProductpricesynclogFactory $productsynclogFactory
    ...
    public function __construct(
        ...
        \Kensium\Synclog\Model\ProductpricesynclogFactory $productsynclogFactory,
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn("message_type", array(
            ...
            'width' => '150',
            'type' => 'options',
            'renderer' => 'Kensium\Synclog\Block\Adminhtml\ProductPrice\Renderer\ViewButton',
