...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = $this->productconfiguratorsynclogFactory->create()->getCollection()->addFieldToFilter('sync_exec_id',$scheduleId);
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn("product_name", array(
            ...
            "align" => "left",
            'renderer' => 'Kensium\Synclog\Block\Adminhtml\ProductConfigurator\Renderer\ProductTitle',
            'width' => '150'
        ...
        $this->addColumn("message_type", array(
                  ...
                  'width' => '150',
                'type' => 'options',
                'renderer' => 'Kensium\Synclog\Block\Adminhtml\ProductConfigurator\Renderer\ViewButton',
