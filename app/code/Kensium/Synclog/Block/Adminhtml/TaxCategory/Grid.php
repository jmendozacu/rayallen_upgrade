...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     * @param \Kensium\Synclog\Model\TaxcategorysynclogFactory $taxCategorysynclogFactory
    ...
    {
        parent::_construct();
        $this->setId('taxCategorySynclogGrid');
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = $this->taxCategorysynclogFactory->create()->getCollection()->addFieldToFilter('sync_exec_id',$scheduleId);
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn("message_type", array(
            ...
            "index" => "message_type",
            'width' => '150',
            'renderer' => 'Kensium\Synclog\Block\Adminhtml\TaxCategory\Renderer\Messagetype',
