...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        parent::_construct();
        $this->setId('productImageSyncLogGrid');
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = $this->productimagesynclogFactory->create()->getCollection()->addFieldToFilter('sync_exec_id',$scheduleId);
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn("message_type", array(
            ...
            "index" => "message_type",
            'width' => '150',
            'renderer' => 'Kensium\Synclog\Block\Adminhtml\Productimage\Renderer\Messagetype',
