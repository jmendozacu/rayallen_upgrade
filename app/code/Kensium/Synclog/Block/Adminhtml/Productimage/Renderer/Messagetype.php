 ...
 */
namespace Kensium\Synclog\Block\Adminhtml\Productimage\Renderer;

use Magento\Framework\DataObject;

/**
 * Class Messagetype
 * @package Kensium\Synclog\Block\Adminhtml\Productimage\Renderer
 */
class Messagetype extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer
{
    ...
    {
        $rowData = $row->getData();
        $url = 'synclog/productimage/detail/id/' . $rowData['id'];
