...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     * @param \Kensium\Synclog\Model\ProductattributesynclogFactory $productAttributesynclogFactory
    ...
    {
        parent::_construct();
        $this->setId('productAttributesynclogGrid');
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = $this->productAttributesynclogFactory->create()->getCollection()->addFieldToFilter('sync_exec_id',$scheduleId);
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn("message_type", array(
            ...
            "index" => "message_type",
            'width' => '150',
            'renderer' => 'Kensium\Synclog\Block\Adminhtml\Productattribute\Renderer\Messagetype',
