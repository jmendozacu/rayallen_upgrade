...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     * @param \Kensium\Synclog\Model\ProductinventorysynclogFactory $productinventorysynclogFactory
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = $this->productinventorysynclogFactory->create()->getCollection()->addFieldToFilter('sync_exec_id',$scheduleId);
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn("message_type", array(
                  ...
                  'width' => '150',
                'type' => 'options',
                'renderer' => 'Kensium\Synclog\Block\Adminhtml\ProductInventory\Renderer\ViewButton',
