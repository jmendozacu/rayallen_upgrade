...
class Shipment extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     * @param \Kensium\Synclog\Model\ShipmentFactory $orderLogFactory
     * @param \Kensium\Synclog\Model\ShipmentsynclogdetailsFactory $ordersynclogdetailsFactory
    ...
    public function __construct(\Magento\Framework\App\Helper\Context $context,
                                ...
                                \Kensium\Synclog\Model\ShipmentFactory $orderLogFactory,
    ...
    public function shipmentSyncSuccessLogs($orderArray = array())
    {
        ...
        try {
            ...
            if($sendLogReport && !empty($orderArray['long_message'])) {
                if ($sendLogReport) {
                    $this->helperData->errorLogEmail('Shipment', $orderArray['long_message']);
                }
            }
            return TRUE;
    ...
    public function shipmentManualSync($orderArray = array())
    {
