...
class Product extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     * @param \Kensium\Synclog\Model\ProductFactory $productLogFactory
     * @param \Kensium\Synclog\Model\ProductsynclogdetailsFactory $productsynclogdetailsFactory
    ...
    public function __construct(
        ...
        \Kensium\Synclog\Model\ProductFactory $productLogFactory,
     ...
     */
    public function productSyncSuccessLogs($dataArray = array())
    {
        ...
        $productLogModel = $this->_objectManager->create('\Kensium\Synclog\Model\Product');
        ...
        $productLogDetailsModel = $this->_objectManager->create('\Kensium\Synclog\Model\Productsynclogdetails');
